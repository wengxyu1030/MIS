...
*c_wasted_sev
	...
	if _rc != 0 {
		foreach k in hc70 hc71 hc72 c_stunted c_stunted_sev c_underweight c_underweight_sev c_wasted c_wasted_sev {
			gen `k' =. 
		}
	}	
...
pause on 
pause motherln hv112	
*mother's line number
	capture confirm variable hv112
		if !_rc {
